...
NAME = minishell
SRC = minishell.c word_splitting.c create_command_list.c environ.c parameter_expansion.c tilde_expansion.c handle_command_list.c create_command_struct.c expansions.c exec.c functions.c ./builtins/builtins.c ./builtins/setenv.c ./builtins/unsetenv.c ./builtins/cd.c ./builtins/echo.c ./builtins/env.c ./builtins/exit.c auto_completion.c
OBJECTS = minishell.o word_splitting.o create_command_list.o environ.o parameter_expansion.o tilde_expansion.o handle_command_list.o create_command_struct.o expansion.o exec.o functions.o builtins.o setenv.o unsetenv.o cd.o echo.o env.o exit.o auto_completion.o
INC = ./
